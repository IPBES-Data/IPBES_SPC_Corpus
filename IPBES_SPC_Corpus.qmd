...
try(
  Sys.setenv(openalexR.apikey = keyring::key_get("API_openalex"))
)
...
render_mermaid(
  ...
  c(
    Set_1 = format_count(ch2_counts[["Set 1"]]),
    Set_2 = format_count(ch2_counts[["Set 2"]]),
    Set_3 = format_count(ch2_counts[["Set 3"]])
  )
)
```
